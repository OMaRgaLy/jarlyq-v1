        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-900 to-slate-800 px-4 pb-36 pt-20 dark:from-slate-950 dark:to-slate-900">
          ...
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-300 sm:text-xl">
              Мы здесь, чтобы помочь тебе найти своё место в IT. Одна платформа вместо десятка телеграм-каналов и сайтов — стажировки, вакансии, компании, школы и карьерные треки.
            </p>

            <p className="mx-auto mt-3 max-w-xl text-base text-slate-400">
              Неважно, на каком этапе — первый шаг, смена направления или охота за оффером. Мы рядом.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto grid max-w-5xl gap-6 sm:grid-cols-2">
            ...
            >
              ...
              <div className="relative">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white sm:text-2xl">
                  Ищу свой путь развития и обучения
                </h2>
                <p className="mt-3 text-sm leading-relaxed text-slate-500 dark:text-slate-400 sm:text-base">
                  В IT столько направлений — и это прекрасно. Исследуй школы, программы, университеты и найди то, от чего загораются глаза.
                </p>
                <div className="mt-5 flex flex-wrap gap-2">
        ...
        <section className="border-y border-slate-200/70 bg-slate-50/80 px-4 py-14 dark:border-slate-800/60 dark:bg-slate-900/30">
          <div className="mx-auto max-w-4xl">
            <h2 className="text-center text-2xl font-bold text-slate-900 dark:text-white sm:text-3xl">
              Всё в одном месте — удобно и просто
            </h2>
            ...
            <div className="mt-10 grid gap-6 sm:grid-cols-3">
              {[
                { icon: '🎯', title: 'Точный поиск', desc: 'Стажировки и вакансии отфильтрованы по стеку, городу и формату. Подавай заявку — жди фидбэк.' },
